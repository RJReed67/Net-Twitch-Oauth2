# This Makefile is for the Net::Twitch::Oauth2 extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Twitch/Oauth2.pm]
#     AUTHOR => [q[Ronald J. Reed <rjreed@gmail.com>]]
#     BUILD_REQUIRES => { Test::Exception=>q[0], Test::MockModule=>q[0], Test::MockObject=>q[0] }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Net::Twitch::Oauth2]
#     PREREQ_PM => { JSON::Any=>q[0], LWP::UserAgent=>q[0], Test::Exception=>q[0], Test::MockModule=>q[0], Test::MockObject=>q[0], URI::Escape=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Net/Twitch/Oauth2.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Net::Twitch::Oauth2
NAME_SYM = Net_Twitch_Oauth2
VERSION = 0.01
...
MAKE = make
FULLEXT = Net/Twitch/Oauth2
BASEEXT = Oauth2
PARENT_NAME = Net::Twitch
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Net/Twitch/Oauth2.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Net/Twitch
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Twitch
...
TO_INST_PM = README.pod \
	lib/Net/Twitch/Oauth2.pm

PM_TO_BLIB = README.pod \
	$(INST_LIB)/Net/Twitch/README.pod \
	lib/Net/Twitch/Oauth2.pm \
...
DISTNAME = Net-Twitch-Oauth2
DISTVNAME = Net-Twitch-Oauth2-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  README.pod $(INST_MAN3DIR)/Net::Twitch::README.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Ronald J. Reed <rjreed@gmail.com>'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'build_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::Exception: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::MockModule: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Net-Twitch-Oauth2' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Ronald J. Reed <rjreed@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Net-Twitch-Oauth2",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Test::MockModule" : "0",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "JSON::Any" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Ronald J. Reed &lt;rjreed@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  README.pod $(INST_LIB)/Net/Twitch/README.pod \
	  lib/Net/Twitch/Oauth2.pm blib/lib/Net/Twitch/Oauth2.pm 
